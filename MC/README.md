...
- Implement the Monte Carlo Prediction to estimate state-action values
  ...
  - [Solution](MC%20Prediction%20Solution.ipynb) 采用采样的方法生成经历，计算V
- Implement the on-policy first-visit Monte Carlo Control algorithm
  ...
  - [Solution](MC%20Control%20with%20Epsilon-Greedy%20Policies%20Solution.ipynb) 采用e-greedy生成经历，计算Q
- Implement the off-policy every-visit Monte Carlo Control using Weighted Important Sampling algorithm
  ...
  - [Solution](Off-Policy%20MC%20Control%20with%20Weighted%20Importance%20Sampling%20Solution.ipynb) 采用重要性采样，计算Q
